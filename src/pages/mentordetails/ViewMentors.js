...
export default function ViewMentors() {
    ...
    const getRows =async (data)=>{
        ...
        data.map((mentor, idx)=>{
            ...
            const temp = {
                ...
                accountHolderName:(mentor.accountDetails && mentor.accountDetails.accountHolderName)?mentor.accountDetails.accountHolderName : "",
                accountNumber: (mentor.accountDetails && mentor.accountDetails.accountNumber)?mentor.accountDetails.accountNumber : "",
                accountType: (mentor.accountDetails && mentor.accountDetails.accountType)?mentor.accountDetails.accountType : "",
                bankAdress: (mentor.accountDetails && mentor.accountDetails.bankAdress)?mentor.accountDetails.bankAdress : "",
                bankName: (mentor.accountDetails && mentor.accountDetails.bankName)?mentor.accountDetails.bankName : "",
                ifscCode: (mentor.accountDetails && mentor.accountDetails.ifscCode)?mentor.accountDetails.ifscCode : "",
                upiId: (mentor.accountDetails && mentor.accountDetails.upiId)?mentor.accountDetails.upiId : "",
                ...
                mentorCalendlyLink:mentor.mentorCalendlyLink?mentor.mentorCalendlyLink : "",
  ...
  return (
    ...
    {mentors? 
        ...
        <div style={{ height: '75%', width: '90%', position: "absolute",top: "50%", right: "50%",transform: "translate(50%,-40%)"}}>
            <DataGrid
