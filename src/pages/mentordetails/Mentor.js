...
import { addMentorInDatabase, getSingleUserFromDatabase, updateMentorAccount, updateMentorCalendly, uploadMedia } from "../../firebase/firebase";
import './style.css' 
...
const Domains = [
    ...
    {value:"Career Advice & Self Mastery", label:"Career Advice & Self Mastery"},
    {value:"Culture", label:"Culture"},
    {value:"Data Science & Analytics", label:"Data Science & Analytics"},
    {value:"Finance, Accounting & Controlling", label:"Finance, Accounting & Controlling"},
    {value:"Human Resources & Recruiting", label:"Human Resources & Recruiting"},
    {value:"Infrastructure & Security Leadership & Management", label:"Infrastructure & Security Leadership & Management"},
    {value:"Legal, Risk Management, Compliance", label:"Legal, Risk Management, Compliance"},
    {value:"Marketing & Growth", label:"Marketing & Growth"},
    {value:"Product Management", label:"Product Management"},
    {value:"Sales", label:"Sales"},
    {value:"Social Entrepreneurship & Charity", label:"Social Entrepreneurship & Charity"},
    {value:"Software Engineering & Charity", label:"Software Engineering & Charity"},
    {value:"Startup: Founding & Funding", label:"Startup: Founding & Funding"},
    {value:"Strategy & Business Development", label:"Strategy & Business Development"},
    {value:"Sustainability", label:"Sustainability"},
    {value:"Team Structure & Work Methodologies", label:"Team Structure & Work Methodologies"},
...
export default function Mentor() {
    ...
    const handleSubmit3 = async(e) =>{
        ...
        if(image){
            ...
            if(result==false){
                ...
                var plans = [chargeph, (chargeph*4).toString(), (chargeph*12).toString(), (chargeph*24).toString()]
    ...
    return (
      <div className="body" style={{display:"block", height: "250vh", width:"98.5vw"}}>
        {!askSignup || !signup ? <>
        {!isMentor ? 
        <form className="form" onSubmit={handleSubmit}>
             <div className="form-panel one">
                ...
                letterSpacing: "0.2em"}} 
                htmlFor="askSignup">Signup? </label>  
        ...
        <form className="form" onSubmit={handleSubmit2}>
          ...
          :null}
            ...
            <div className="form-panel one">
                <div className="form-header">
                 <h1>Mentor Form</h1>
                 <p style={{margin:"0px"}}>Note:- Enter Bank details or UPI ID*</p>
                </div>
                <div className="form-group">
          ...
          <div className="form-group">
          <button type="submit">{uploading?"UPLOADING... Dont Touch Anything!😣":"Submit"}</button>
          </div>
          </div>
          </form>
          :null
